...
export class ProductsListPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public platform: Platform,
    public actionsheetCtrl: ActionSheetController, public productService:ProductsProvider) {
      this.products=this.navParams.get("produits");
  ...
  ionViewWillLeave() {
    this.productService.catList.splice(0,this.productService.catList.length);
  }
}
